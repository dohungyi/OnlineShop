...
var couponsList = new List("couponsList", options).on(
  "updated",
  function (list) {
...
Array.prototype.slice.call(forms).forEach(function (form) {
  form.addEventListener("submit", function (event) {
    ...
    if (
      ...
      couponsList.add({
        id:
          '<a href="javascript:void(0);" class="fw-medium link-primary">#TB' +
          count +
          "</a>",
      ...
      btn.addEventListener("click", function (e) {
        ...
        Array.from(itemValues).forEach(function (x) {
          ...
          if (selectedid == itemId) {
            ...
            //discount
            discountVal = new DOMParser().parseFromString(
              x._values.discount,
              "text/html"
            );
          ...
          if (selectedid == itemId) {
            var codeBlock = `
                <div class="offcanvas-header bg-warning-subtle">
                        <h5 class="offcanvas-title" id="couponDetails">${
                          x._values.couponTitle
                        }</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td><span class="fw-medium text-uppercase">${
