...
var sellersList = new List("sellersList", options).on(
  "updated",
  function (list) {
      ...
      btn.addEventListener("click", function (e) {
        ...
        Array.from(itemValues).forEach(function (x) {
          ...
          if (selectedid == itemId) {
            ...
            var val = new DOMParser().parseFromString(
              x._values.accountStatus,
              "text/html"
            );
...
statusInput.passedElement.element.addEventListener(
  "change",
  function (event) {
