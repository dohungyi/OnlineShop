...
if (
  ...
  if (viewobj != "" && options == "view-invoice") {
    ...
    document.getElementById("contact-no").innerHTML =
      viewobj.company_details.contact_no;
    ...
    document.getElementById("shipping-phone-no").innerHTML =
      viewobj.shipping_address.phone;
    ...
    document.getElementById("card-number").innerHTML =
      viewobj.payment_details.card_number;
    document.getElementById("card-total-amount").innerHTML =
      viewobj.payment_details.total_amount;
