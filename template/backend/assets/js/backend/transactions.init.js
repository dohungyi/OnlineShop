...
var transactionsList = new List("transactionsList", options).on(
  "updated",
  function (list) {
...
const values = [
  {
    ...
    label:
      '<img src="../assets/images/ecommerce/payment/american-express.png" class="avatar-xxs me-1"/> American Express',
    id: 1,
  },
  {
    value: "PayPal",
    label:
      '<img src="../assets/images/ecommerce/payment/paypal.png" class="avatar-xxs me-1"/> American PayPal',
    id: 2,
  },
  {
    value: "Discover",
    label:
      '<img src="../assets/images/ecommerce/payment/discover.png" class="avatar-xxs me-1"/> Discover',
    id: 3,
  },
  {
    value: "Visa Credit/Debit",
    label:
      '<img src="../assets/images/ecommerce/payment/visa.png" class="avatar-xxs me-1"/> Visa Credit/Debit',
    id: 4,
  },
];
      ...
      paymentMethod:
        '<div class="d-flex align-items-center gap-2">\
                            <div class="flex-shrink-0">\
                                <img src="' +
        element.paymentMethod[0] +
        '" alt="" class="avatar-xs object-fit-cover paycard-image">\
                            </div>\
                            <div class="flex-grow-1">\
                                <h6 class="mb-0 paycard">' +
        element.paymentMethod[1] +
        "</h6>\
                            </div>\
                        </div>",
    ...
    Array.from(viewBtns).forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        ...
        Array.from(itemValues).forEach(function (x) {
          ...
          var isTransID = new DOMParser().parseFromString(
            x._values.transactionID,
            "text/html"
          );
          var isTransIDVal = isTransID.body.firstElementChild.innerHTML;
          var isPaymethod = new DOMParser().parseFromString(
            x._values.paymentMethod,
            "text/html"
          );
