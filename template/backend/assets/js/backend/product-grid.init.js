    ...
    if (datas[i]) {
      ...
      if (datas[i].size) {
        ...
        Array.from(datas[i].size).forEach(function (elem) {
          ...
          sizeElem +=
            ...
            num +
            '">\
                                        <label class="avatar-xxs border border-2 border-white btn btn-soft-primary text-uppercase p-0 fs-12 d-flex align-items-center justify-content-center rounded-circle" for="product-size-' +
            datas[i].id +
            num +
            '">' +
            elem +
      ...
      if (discount > 0) {
        ...
        var afterDiscountElem =
          '<h5 class="text-primary fs-17 mb-0">$' +
        ...
        var discountElem = "";
        var afterDiscountElem =
          '<h5 class="text-primary fs-17 mb-0">$' + datas[i].price + "</h5>";
      }
      ...
      document.getElementById("product-grid").innerHTML +=
            ...
            <div class="card ecommerce-product-widgets overflow-hidden">\
                <div class="card-body">\
                    <div class="bg-light rounded py-5 position-relative">\
                        ...
                        <img src="' +
        datas[i].productImg +
        '" alt="" style="max-height: 150px;max-width: 100%;" class="mx-auto d-block rounded-2">\
                        ' +
        discountElem +
        '\
                    </div>\
        ...
        "\
                            <span>" +
        datas[i].rating +
        ' <i class="ri-star-half-fill text-warning align-middle"></i></span>\
                        </div>\
                        <a href="#!">\
