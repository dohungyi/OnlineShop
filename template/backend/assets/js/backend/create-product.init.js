...
if (editinputValueJson) {
  ...
  document.getElementById("product-discount-input").value =
    editinputValueJson.discount;
  document.getElementById("orders-input").value = editinputValueJson.orders;

  // clothe-colors
  Array.from(document.querySelectorAll(".clothe-colors li")).forEach(function (
    subElem
  ) {
  ...
  // clothe-size
  Array.from(document.querySelectorAll(".clothe-size li")).forEach(function (
    subElem
  ) {
    var nameelem = subElem.querySelector('[type="checkbox"]');
  ...
  form.addEventListener(
    ...
    function (event) {
      if (!form.checkValidity()) {
        ...
        var productDiscountVal = document.getElementById(
