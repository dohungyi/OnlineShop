...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    eventClick: function (info) {
      ...
      document.getElementById("event-payment-tag").innerHTML =
        selectedEvent.extendedProps.payment === undefined
          ? "No Location"
      ...
      document.getElementById("event-location").value =
        selectedEvent.extendedProps.location === undefined
          ? "No Location"
          : selectedEvent.extendedProps.location;
      document.getElementById("event-payment").value =
        selectedEvent.extendedProps.payment === undefined
          ? ""
          : selectedEvent.extendedProps.payment;
    ...
    eventContent: function (arg) {
      ...
      return {
        html:
          '<div class="fc-event-title fc-sticky">#TBT8' +
          arg.event.id +
          " - " +
          arg.event.title +
          "</div>",
    ...
    u_event =
      '<div class="card">\
        <div class="card-body">\
            <div class="d-flex align-items-center mb-4">\
                <p class="mb-0 flex-grow-1">OrderID: <span class="fw-medium">#TBT8' +
      element.id +
      '</span></p>\
      ...
      '</h5>\
            <div class="d-flex justify-content-between align-items-center mb-0">\
                <p class="mb-0"><i class="bi bi-calendar2-check me-1 text-muted align-middle"></i>' +
      startDate +
      '</p>\
                <p class="mb-0"><i class="bi bi-box-seam me-1 text-muted align-middle"></i>' +
      end_dt +
      "</p>\
            </div>\
        </div>\
