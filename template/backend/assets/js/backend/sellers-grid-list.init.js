...
function loadSellersListData(datas, page) {
  ...
  for (
    ...
    var checkVerified = datas[i].verified
      ? '<i class="ph-circle-wavy-check-fill text-primary align-middle fs-15 ms-1"></i></h5>'
      : "";
    ...
    document.getElementById("seller-list").innerHTML +=
      ...
      '" alt="" class="avatar-xs">\
                ...
                <div class="text-center mt-3">\
                    <a href="seller-overview.html"><h5 class="mb-1">' +
      datas[i].sellerName +
      checkVerified +
      '</h5></a>\
                ...
                <div class="mt-4 hstack gap-2">\
                    ...
                    <div class="dropdown flex-shrink-0">\
                        ...
                        <ul class="dropdown-menu">\
                            <li><a class="dropdown-item edit-list" href="#createModal" data-bs-toggle="modal" data-edit-id="' +
      datas[i].id +
      '">Edit</a></li>\
                            <li><a class="dropdown-item remove-list" href="#deleteRecordModal"  data-remove-id="' +
      datas[i].id +
...
searchInputList.addEventListener("keyup", function () {
  ...
  function filterItems(arr, query) {
    return arr.filter(function (el) {
      return (
        el.sellerName.toLowerCase().indexOf(query.toLowerCase()) !== -1 ||
        el.webUrl.toLowerCase().indexOf(query.toLowerCase()) !== -1
      );
    });
  }
